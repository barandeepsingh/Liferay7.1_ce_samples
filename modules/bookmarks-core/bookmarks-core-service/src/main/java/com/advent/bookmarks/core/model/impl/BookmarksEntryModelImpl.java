...
import com.advent.bookmarks.core.model.BookmarksEntryModel;
import com.advent.bookmarks.core.model.BookmarksEntrySoap;
...
/**
 * The base model implementation for the BookmarksEntry service. Represents a row in the &quot;Bookmarks_BookmarksEntry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class BookmarksEntryModelImpl extends BaseModelImpl<BookmarksEntry>
	 ...
	 */
	public static final String TABLE_NAME = "Bookmarks_BookmarksEntry";
	...
	public static final String TABLE_SQL_CREATE = "create table Bookmarks_BookmarksEntry (mvccVersion LONG default 0 not null,uuid_ VARCHAR(75) null,entryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,folderId LONG,treePath VARCHAR(75) null,name VARCHAR(75) null,url VARCHAR(75) null,description VARCHAR(75) null,visits INTEGER,priority INTEGER,lastPublishDate DATE null,status INTEGER,statusByUserId LONG,statusByUserName VARCHAR(75) null,statusDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table Bookmarks_BookmarksEntry";
	public static final String ORDER_BY_JPQL = " ORDER BY bookmarksEntry.folderId ASC, bookmarksEntry.name ASC";
	public static final String ORDER_BY_SQL = " ORDER BY Bookmarks_BookmarksEntry.folderId ASC, Bookmarks_BookmarksEntry.name ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.advent.bookmarks.core.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.advent.bookmarks.core.model.BookmarksEntry"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.advent.bookmarks.core.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.advent.bookmarks.core.model.BookmarksEntry"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.advent.bookmarks.core.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.advent.bookmarks.core.model.BookmarksEntry"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.advent.bookmarks.core.service.util.ServiceProps.get(
				"lock.expiration.time.com.advent.bookmarks.core.model.BookmarksEntry"));
	...
	*/
	...
	public String toXmlString() {
		...
		sb.append("com.advent.bookmarks.core.model.BookmarksEntry");
