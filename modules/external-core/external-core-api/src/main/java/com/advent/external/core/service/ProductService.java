...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=external", "json.web.service.context.path=Product"}, service = ProductService.class)
@ProviderType
...
public interface ProductService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProductServiceUtil} to access the product remote service. Add custom service methods to {@link com.advent.external.core.service.impl.ProductServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
